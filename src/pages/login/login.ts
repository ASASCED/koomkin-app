...
export class LoginPage implements OnInit {
  ...
  public doLogin() {
    ...
    this.showLoader();
    this.authService.getUserByEmail(this.email).then(
      data => {
        this.loading.dismiss();
        this.leads = data;
      ...
      err => {
        ...
        this.showError(
          "Error de conexión.",
          "No fue posible establecer una conexión con el servidor.\n Verifique su conexión a internet."
        );
        // console.log(err);
      }
    );
  ...
  getIntentoSesion(email, password) {
    ...
    this.restService.getIntentoSesion(email, password).then(
      data => {
