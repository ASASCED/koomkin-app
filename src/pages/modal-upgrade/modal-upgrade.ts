...
export class ModalUpgradePage {
      ...
      this.http.post(url, cuerpo, options).subscribe(
        data => {
          ...
          if (data["result"] == "OK") {
            ...
            data["result"] ==
            "Upsell aplicado pero no se aplicó el cargo. Se intentará en el siguiente pago recurrente."
          ) {
            loading.dismiss();
  ...
  public getDowngradeMembership(upsell_id) {
    this.provedor.getDowngradeMembership(upsell_id).then(
      data => {},
      error => {
        console.log(error);
      }
  ...
  public getRegisterUpdateMembership() {
    ...
    this.provedor.getRegisterUpdateMembership(this.id, idpopup, canal).then(
      data => {
        console.log(data);
      },
      error => {
  ...
  public getInsertUpgradeMembresia() {
    ...
    this.provedor
      .getInsertUpgradeMembresia(this.id, this.idRecurrente, acceso)
      .then(
        data => {
          console.log(data);
        },
